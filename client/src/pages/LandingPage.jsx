        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-indigo-600">EduAnalytics</h1>
            </div>
            <div className="flex space-x-4">
              <Link 
                to="/login" 
                className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md text-md font-medium transition-colors"
              >
                Login
              </Link>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-4">
        <div className="text-center">
          <h1 className="text-3xl md:text-7xl font-semibold text-gray-900 mb-4">
            ...
            <span className="text-indigo-600 block">Performance Analytics</span>
          </h1>
