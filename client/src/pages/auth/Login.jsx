            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-3 py-2 border border-gray-200 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[#6e63e5] focus:border-[#6e63e5] pr-10"
              ...
              <div>
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full flex justify-center py-2 px-4 border border-transparent rounded-xl shadow-sm text-sm font-medium text-white bg-[#6e63e5] hover:bg-[#4c46a0] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#6e63e5] disabled:opacity-50"
                >
                  {isLoading ? (
                    <>
